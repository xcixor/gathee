# Generated by Django 2.2.7 on 2019-11-26 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=150, unique=True)),
                ('video_file', models.FileField(null=True, upload_to='videos', verbose_name='Select Video:')),
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='videos', to='subscriptions.Course')),
            ],
        ),
        migrations.CreateModel(
